...
const BASIC_URL="https://universal-shopping-app-production.up.railway.app/";
...
addProductToWishList(wishlistDto:any): Observable<any>{
 ...
 removeWishlistProduct(productId:any): Observable<any>{
  const wishlistDto={
    productId:productId,
    userId: UserStorageService.getUserId()
  }
  return this.http.delete(BASIC_URL+'api/customer/wishlist',{
    headers: this.createAuthorizationHeader(),
    body: wishlistDto
  })
}

removeCartProduct(productId:any,quantity:any): Observable<any>{
  const cartDto={
    productId:productId,
    userId: UserStorageService.getUserId(),
    quantity:quantity
  }
  return this.http.delete(BASIC_URL+'api/customer/cart',{
    headers: this.createAuthorizationHeader(),
    body: cartDto
  })
}
